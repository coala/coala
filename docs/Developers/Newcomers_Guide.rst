...
Requests- we hate it when someone's time is wasted. For your own sake, please
...
recommend that you start with a ``newcomer`` issue, end with a ``low`` issue, and
...
we care!
>>>>>>> 13c4515... Newcomers_Guide: Improve English flow and grammar
...
to create a ``Pull Request``. You can do this by accessing your fork on GitHub and
