...
possible that it may have already been fixed as a result of a PR for a different
issue.
...
.. important::
    ...
    * If the issue is some grammatical or spelling error either in comments or
      documentation, then figure out whether the problem still exists and if so,
...
- Check whether an open pull request exists. If it exists, then you may look
  ...
  case, you need to claim that you would like to work on the issue and also ask
