...
class UnescapedSearchInBetweenTest(StringProcessingTest):
    ...
    test_basic_expected_results = [
        ...
        [InBetweenMatch(Match(test_basic_pattern, 5),
                        ...
                        Match(test_basic_pattern, 32))],
        [InBetweenMatch(Match(test_basic_pattern, 5),
                        Match(r"escaped-quote at end:   \'", 6),
                        Match(test_basic_pattern, 32))],
        [InBetweenMatch(Match(test_basic_pattern, 5),
    ...
    def test_extended(self):
        expected_results = [
            ...
            [InBetweenMatch(Match("(", 6),
                            Match("do (it ", 7),
                            Match(")", 14)),
             InBetweenMatch(Match("(", 41),
                            Match("", 42),
                            Match(")", 42)),
             InBetweenMatch(Match("(", 44),
                            Match("hello.", 45),
                            Match(")", 51))],
            [InBetweenMatch(Match("(", 0),
                            Match("", 1),
                            Match(")", 1)),
             InBetweenMatch(Match("(", 8),
                            Match(r"This\ is a word\)and((in a\\\ word\\\\\) "
                                  r"another \)",
                                  9),
                            Match(")", 60))],
            [InBetweenMatch(Match("(", 10),
                            Match(r"((((\\\(((((((((((1", 11),
                            Match(")", 30))],
            [InBetweenMatch(Match("(", 11),
                            Match("it ", 12),
                            Match(")", 15)),
