...
from coalib.collecting import Collector
...
class SectionManager:
    ...
    def _fill_settings(self):
        for section_name in self.conf_sections:
            ...
            local_bears = Collector.collect_bears(path_list(section["bear_dirs"]),
                                                  list(section["bears"]),
                                                  [BEAR_KIND.LOCAL])
            global_bears = Collector.collect_bears(path_list(section["bear_dirs"]),
                                                   list(section["bears"]),
                                                   [BEAR_KIND.GLOBAL])
