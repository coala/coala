...
def create_json_encoder(**kwargs):
    class JSONEncoder(json.JSONEncoder):
        ...
        def default(self, obj):
            ...
            elif sys.version_info.major == 3 and sys.version_info.minor < 7 and
                isinstance(obj, re._pattern_type):
                return obj.pattern  # pragma: no py37 cover
            elif sys.version_info.major == 3 and sys.version_info.minor >= 7 and
                isinstance(obj, re.Pattern):
                return obj.pattern  # pragma: no cover
