...
class LocalBearTestHelper(unittest.TestCase):
    ...
    def check_invalidity(self,
        ...
        :param filename:
            The filename, if it matters.
        :param force_linebreaks:
            Whether to append newlines at each line
    ...
    def check_results(self,
        ...
        :param tempfile_kwargs:
            Kwargs passed to tempfile.mkstemp().
        :param settings:
            A dictionary of keys and values (both strings)
...
def verify_local_bear(bear,
    ...
    :param valid_files:
        An iterable of files as a string list that won't
        yield results.
    :param invalid_files:
        An iterable of files as a string list that must
        yield results.
    :param filename:
        The filename to use for valid and invalid files.
    :param settings:
        A dictionary of keys and values (both string) from
    ...
    :param tempfile_kwargs:
        Kwargs passed to tempfile.mkstemp() if tempfile
        needs to be created.
    :return:
