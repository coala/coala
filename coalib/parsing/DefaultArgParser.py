...
default_arg_parser.add_argument('-i', '--ignored_paths', nargs='+', metavar=_('PATH'), dest='ignored_paths',
...
default_arg_parser.add_argument('-l', '--log_type', nargs=1, choices=['CONSOLE', 'TXT', 'HTML'], metavar=_('ENUM'),
