...
class Cursor(Structure):
    ...
    def semantic_parent(self):
        ...
        if not hasattr(self, '_semantic_parent'):
            self._semantic_parent = \
                conf.lib.clang_getCursorSemanticParent(self)
...
class Index(ClangObject):
    ...
    def parse(self, path, args=None, unsaved_files=None, options = 0):
        ...
        to as unsaved_files, the first item should be the filenames to be
        mapped and the second should be the contents to be substituted for the
...
class TranslationUnit(ClangObject):
    ...
    def get_includes(self):
        ...
        def visitor(fobj, lptr, depth, includes):
            if depth > 0:
                loc = lptr.contents
                includes.append(FileInclusion(loc.file,
                                              File(fobj),
                                              loc,
                                              depth))
...
class FileInclusion(object):
    ...
    including file, the location of the '#include' directive and the depth of
    the included file in the stack. Note that the input file has depth 0.
    """
...
class Config:
    ...
    def set_compatibility_check(check_status):
        ...
        himself if the features he is using are available and compatible
