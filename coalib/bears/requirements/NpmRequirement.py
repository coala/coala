...
class NpmRequirement(Requirement):
    ...
    proper type for ``npm`` packages automatically and provides a function to
    check for the requirement.
    """

    def __init__(self, package, version=""):
        """
        Constructs a new ``NpmRequirement``, using the ``Requirement``
        constructor.
        ...
        """
        Requirement.__init__(self, 'npm', package, version)
