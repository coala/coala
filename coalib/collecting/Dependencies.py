...
def _resolve_dependencies(bears, resolved_bears, seen):
    for bear in bears:
        ...
        seen.append(bear)
        resolved_bears = _resolve_dependencies(missing, resolved_bears, seen)
        resolved_bears.append(bear)
...
def resolve_dependencies(bears):
    """
    ...
    """
    return _resolve_dependencies(bears, [], [])
